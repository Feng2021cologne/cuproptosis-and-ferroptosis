...
GSE81089 = read.table("GSE81089",header = T,row.names = NULL,sep = "\t")

data = inner_join(tcga,GSE30219,by="row.names")
data = inner_join(data,GSE31210,by="row.names")
data = inner_join(data,GSE3141,by="row.names")
data = inner_join(data,GSE37745,by="row.names")
data = inner_join(data,GSE81089,by="row.names")
